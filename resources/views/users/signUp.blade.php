...
<body>
    ...
    <div class="container m-3 p-5 text-dark mx-auto">
        ...
        <form action="userForm" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-check">
                <input type="checkbox" class="form-check-input" name="hobby[]" id="writing" value="writing">
                <label for="writing" class="form-check-label">Writing</label>
            </div>

            <div class="form-check">
                <input type="checkbox" class="form-check-input" name="hobby[]" id="playing" value="playing">
                <label for="playing" class="form-check-label">Playing</label>
            </div>

            <div class="form-check">
                <input type="checkbox" class="form-check-input" name="hobby[]" id="cooking" value="cooking">
